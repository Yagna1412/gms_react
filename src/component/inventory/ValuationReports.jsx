    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Inventory analytics and insights</p>
        </div>
        <div className="flex gap-3">
          <button className="px-4 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-colors flex items-center gap-2" onClick={handleEmailReport}>
            <Mail size={18} />
            Email Report
          </button>
          <button className="px-4 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-colors flex items-center gap-2" onClick={handlePrintPDF}>
            <Printer size={18} />
            Print PDF
          </button>
      ...
      <div className="bg-white rounded-2xl p-2 border border-gray-200 inline-flex gap-2">
        <button
          ...
          className={`px-6 py-2.5 rounded-xl font-semibold transition-colors ${reportType === 'valuation' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-100'
            }`}
        >
          Inventory Valuation
        </button>
        <button
          ...
          className={`px-6 py-2.5 rounded-xl font-semibold transition-colors ${reportType === 'aging' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-100'
            }`}
        >
          Stock Aging
        </button>
      ...
      {reportType === 'valuation' && (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-white">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-sm opacity-90">Total Inventory Value</span>
              </div>
              <div className="text-4xl font-bold">₹{(totalInventoryValue / 1000).toFixed(1)}K</div>
            ...
            <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-2xl p-6 text-white">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-sm opacity-90">Potential Revenue</span>
              </div>
              <div className="text-4xl font-bold">₹{(totalSellingValue / 1000).toFixed(1)}K</div>
            ...
            <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl p-6 text-white">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-sm opacity-90">Potential Profit</span>
              </div>
              <div className="text-4xl font-bold">₹{(potentialProfit / 1000).toFixed(1)}K</div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Category-wise Inventory Value</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="relative">
                <div className="w-64 h-64 mx-auto">
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                    ...
                    <div className="text-lg font-bold text-gray-900">₹{(totalInventoryValue / 1000).toFixed(0)}K</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {categoryData.map((cat, index) => (
                  <div key={cat.category} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                    ...
                    <div className="text-right">
                      <div className="font-bold text-gray-900">₹{(cat.value / 1000).toFixed(1)}K</div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Top 10 High-Value Items</h2>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Top 10 Fast-Moving Items</h2>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Turnover</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
      ...
      {reportType === 'aging' && (
        <>
          {/* Stock Aging Summary */}
          <div className="bg-white rounded-2xl p-6 border border-gray-200">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Stock Aging Analysis</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="bg-green-50 rounded-2xl p-6">
                <div className="text-xs font-semibold text-gray-600 mb-2">0-30 Days</div>
                <div className="text-3xl font-bold text-green-600">{Math.round(stockAging['0-30 days'])}</div>
                <div className="text-xs text-gray-600 mt-1">items</div>
              </div>

              <div className="bg-blue-50 rounded-2xl p-6">
                <div className="text-xs font-semibold text-gray-600 mb-2">30-60 Days</div>
                <div className="text-3xl font-bold text-blue-600">{Math.round(stockAging['30-60 days'])}</div>
                <div className="text-xs text-gray-600 mt-1">items</div>
              </div>

              <div className="bg-yellow-50 rounded-2xl p-6">
                <div className="text-xs font-semibold text-gray-600 mb-2">60-180 Days</div>
                <div className="text-3xl font-bold text-yellow-600">{Math.round(stockAging['60-180 days'])}</div>
                <div className="text-xs text-gray-600 mt-1">items</div>
              </div>

              <div className="bg-red-50 rounded-2xl p-6">
                <div className="text-xs font-semibold text-gray-600 mb-2">&gt;180 Days</div>
                <div className="text-3xl font-bold text-red-600">{Math.round(stockAging['>180 days'])}</div>
                <div className="text-xs text-gray-600 mt-1">Dead Stock</div>
              </div>
            </div>

            <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-xl">
              <h3 className="font-bold text-red-900 mb-2">Dead Stock Recommendations</h3>
              <ul className="space-y-2 text-sm text-red-800">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-red-600">•</span>
                  <span>Review minimum stock levels for slow-moving items</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-600">•</span>
                  <span>Identify and liquidate obsolete inventory</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Aging Breakdown</h2>
              ...
              {Object.entries(stockAging).map(([period, count], index) => (
                <div key={period}>
                  ...
                  <div className="w-full h-4 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      className={`h-full ${index === 0 ? 'bg-green-500' :
                        index === 1 ? 'bg-blue-500' :
                          index === 2 ? 'bg-yellow-500' :
                            'bg-red-500'
                        }`}
                      style={{ width: `${(count / items.filter(i => i.currentStock > 0).length) * 100}%` }}
                    ></div>
                  </div>
                </div>
              ))}
